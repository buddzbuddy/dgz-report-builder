...
@Component({
  selector: 'app-create-community-registration',
  templateUrl: './create-community-registration.component.html',
  styleUrls: ['./create-community-registration.component.scss']
})
