...
export class CamundaRestService {
  //private engineRestUrl = 'http://' + location.host + ':8080/engine-rest/'//prod
  private engineRestUrl = '/engine-rest/'//dev
  ...
  getAllVariablesForTask(taskId: String): Observable<any> {
